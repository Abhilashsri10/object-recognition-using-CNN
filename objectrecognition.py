...
cb=ModelCheckpoint(filepath,monitor='acc',verbose=1,save_best_only=True,mode='max')
#training
model.fit(x_train,y_train,callbacks=[cb],validation_data=(x_test,y_test),epochs=epochs,batch_size=32)
'''
